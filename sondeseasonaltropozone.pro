...
;   Function: sondeseasonaltropozone
;
;   Purpose: return monthly averaged molecs/cm2 below the tropopause
;
;   Inputs:
;       keyword for site = davis,mac, or melb
;
;   Returns:
;       tropospheric molecules/cm2
;   
;   Outputs:
;       means: monthly means for dataset
;       meds: monthly medians for dataset
;       stds: monthly standard deviations for dataset
;   
;   KEYWORDS:
;       ANALYSE : plot the monthly means
;       DAVIS   : over davis etc...
;   NOTES:
;       A cannibal passed his friend in the woods
 
FUNCTION sondeseasonaltropozone, $
  means=means, meds=meds, stds=stds, tps=tps,$
  analyse=analyse, contourppbv=contourppbv, $
  ppbvs=ppbvs, hppbvs=hppbvs
